...
//                 color:  Color.fromARGB(255, 44, 176, 237),
//                 child: Container(
//                   decoration: BoxDecoration(color:  Color.fromARGB(255, 50, 41, 218)),
//                   child: Center(
//                     child: Text(
//                       "CADT STUDENT",
//                       style: TextStyle(
...
//                       height: 170,
//                       decoration: BoxDecoration(
//                         color: Color.fromARGB(255, 214, 133, 214),
//                         borderRadius: BorderRadius.circular(15),
//                       ),
//                       child: Center(
//                         child: Text(
...
//                       height: 170,
//                       decoration: BoxDecoration(
//                         color: Color.fromARGB(219, 183, 63, 183),
//                         borderRadius: BorderRadius.circular(15),
//                       ),
//                       child: const Center(
//                         child: Text(
...
//                       height: 170,
//                       decoration: BoxDecoration(
//                         color: Color.fromARGB(219, 157, 21, 157),
//                         borderRadius: BorderRadius.circular(15),
//                       ),
//                       child: Center(
//                         child: Text(
...
//                       height: 170,
//                       decoration: BoxDecoration(
//                         color: Color.fromARGB(219, 115, 10, 115),
//                         borderRadius: BorderRadius.circular(15),
//                       ),
//                       child: Center(
//                         child: Text(
